...
export const BLOGS = [
  ...
  },
  {
    ...
    description:
      "Discover the best farming techniques for farmlands near Bangalore ÃÂ¢ÃÂÃÂ organic farming, hydroponics, drip irrigation & precision farming explained.",
    date: "2026",
    ...
    sections: [
      ...
      },
      {
        ...
        textAfter:
          "ÃÂ¢ÃÂÃÂ from organic practices that respect the land to high-tech solutions that maximize yield. LetÃÂ¢ÃÂÃÂs explore the best ways to grow and thrive on your farmland.",
      },
      {
        type: "p",
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        href: "https://www.novaranatureestates.com/projects",
        textAfter:
          " donÃÂ¢ÃÂÃÂt worry! WeÃÂ¢ÃÂÃÂve broken it down into simple steps to guide you through the process. By the end of this post, youÃÂ¢ÃÂÃÂll have a clear understanding of how to get started, what to consider, and why investing in farmland could be one of the best decisions you ever make.",
      },
    ...
    sections: [
      {
        type: "p_with_link",
        textBefore:
          "Life in Bangalore can get fast-paced. With the traffic, deadlines, and constant hustle, itÃÂ¢ÃÂÃÂs no wonder more and more people are looking for a place to unwind and reconnect with nature. Imagine this: after a busy week in the city, you drive just a couple of hours to a peaceful, serene retreat surrounded by greenery, fresh air, and open spaces. No, it's not a dream ÃÂ¢ÃÂÃÂ it's becoming a reality with ",
        linkText: "farmlands near Bangalore.",
        href: "https://www.novaranatureestates.com",
        textAfter: "",
      },
    ...
    sections: [
      {
        type: "p_with_link",
        textBefore:
          "Farmland is more than just a plot of land ÃÂ¢ÃÂÃÂ itÃÂ¢ÃÂÃÂs an investment that can work for you. Whether youÃÂ¢ÃÂÃÂre an aspiring farmer or someone looking to diversify your income streams, generating passive income from ",
...

  {
    ...
    sections: [
      ...
      },
      {
        type: "p_with_link",
        textBefore:
          "One of the most noticeable trends in IndiaÃÂ¢ÃÂÃÂs agricultural sector is the rising demand for ",
  ...
  },
  {
    ...
    description:
      "Discover Ecovara Farms near Lepakshi ÃÂ¢ÃÂÃÂ Novara Nature Estates' premium managed farmland 75 mins from Bangalore. Clear titles, 800+ trees. Book a free farm visit.",
    date: "2026",
